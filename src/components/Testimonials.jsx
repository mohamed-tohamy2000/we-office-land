...
export default function Testimonials() {
  const testimonialsImgs = [
    "https://placehold.co/400x250?text=Chat+1",
    "https://placehold.co/400x250?text=Chat+2",
    "https://placehold.co/400x250?text=Chat+3",
    "https://placehold.co/400x250?text=Chat+4",
    "https://placehold.co/400x250?text=Chat+5",
    "https://placehold.co/400x250?text=Chat+6",
  ];
    ...
    <section id="testimonials" className="py-20 bg-white">
      <div className="container mx-auto px-6">
        ...
        <Swiper
          ...
          slidesPerView={1}
          breakpoints={{
            640: { slidesPerView: 2 }, // موبايل
            1024: { slidesPerView: 3 }, // ديسكتوب
          }}
        >
          {testimonialsImgs.map((img, i) => (
